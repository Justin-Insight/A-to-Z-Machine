...
seo:
  ...
  featured_image: cnc-machining-tools-on-shelf.jpg
hero:
  image:
    hero_image: cnc-machining-tools-on-shelf.jpg
    hero_image_alt:
...
industries:
  - heading: Agriculture
    ...
    image_alt: A tractor bailing up hay
  - heading: Heavy Industry Trucking & Transportation
    image: heavy-industry-trucking.jpg
    image_alt: a large open bed semi driving down a two lane road
  - heading: Military
    image: military.jpg
    image_alt: 2 large military vehicles driving through an open field
  - heading: Scientific Research Equipment
    image: research-equipment.jpg
    image_alt: a petri dish underneath a microscope
  - heading: Electronic
    image: electronic.jpg
    image_alt: hands working on small electrical component
  - heading: Food Processing
    image: food-750x750.jpg
    image_alt: an industrial canning production line
  - heading: Oil
    image: oil.jpg
    image_alt: an oil pump at sunset
  - heading: Gas
    image: gas.jpg
    image_alt: gas guages
  - heading: Wind & Energy
    image: energy.jpg
    image_alt: a large number of windmills on horizon
  - heading: Marine & Oceanographic
    image: marine.jpg
    image_alt: a large ship out on the water
  - heading: Material Handling
    image: material-handling.jpg
    image_alt: a forklift parked underneath a large stack of wood
  - heading: Service & Repair
    image: service-repair.jpg
    image_alt: a ford truck on a repair lift
  - heading: Medical & Consumer Products
    image: medical-products.jpg
    image_alt: an MRI machine in an exam room
  - heading: Product Test Development
    image: product-testing.jpg
    image_alt: vehicle having an alignment performed on it
  - heading: Engineering & Construction
    image: construction.jpg
    image_alt: a large excavator digging in the dirt
a_to_z_adapts:
